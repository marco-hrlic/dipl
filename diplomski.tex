...
\begin{alg}{IHT}
    ...
    \textit{Iteracija:} Zaustavi kada $n = \bar{n}$:
        ...
        \end{equation}
        \textit{Izlaz:} $s$-rijedak vektor $\vec x^{\sharp}=\vec x^{\barn}$.
\end{alg}
...
\chapter[BP algoritam][BP algoritam]{BP algoritam}
